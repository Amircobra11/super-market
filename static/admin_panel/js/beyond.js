...
if (location.pathname != "/home-rtl-fa.html" && location.pathname != "/home-rtl-ar.html") {
    ...
    $("#sidebar-collapse").on('click', function () {
        ...
        if (b) {
            ...
            if ($('.page-sidebar').hasClass('sidebar-fixed')) {
                var position = (readCookie("rtl-support") || location.pathname == "/home-rtl-fa.html" || location.pathname == "/home-rtl-ar.html") ? 'right' : 'left';
